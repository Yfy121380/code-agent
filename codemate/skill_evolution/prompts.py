...
EXTRACTOR_SYSTEM_PROMPT = (
    ...
    "Extract at most ONE reusable skill candidate from a structured conversation window.\n"
    "Output ONLY strict JSON: {\"skills\": []} or {\"skills\": [{...}]}.\n\n"
    "Candidate fields: name, description, when_to_use, instructions, evidence, tags.\n\n"
    "Window semantics:\n"
    "- focus_conversation is the completed turn being evaluated.\n"
    "- supporting_conversations are earlier complete turns used only to explain context, confirm repetition, or show how a workflow evolved.\n"
    "- next_user_feedback may confirm, reject, or refine the focus turn, but it may also be unrelated. Do not force a connection.\n"
    "- Do not extract a candidate solely from supporting_conversations.\n\n"
    "Rules:\n"
    "- USER turns are the primary evidence. Assistant turns are context only.\n"
    "- Tool events are bounded observations of what happened; they are not by themselves evidence of a durable user preference.\n"
