...
LIST_FILE_LINE_COUNT_MAX_BYTES = 10 * 1024 * 1024
BINARY_SNIFF_BYTES = 8192
IMAGE_EXTENSIONS = {".gif", ".jpeg", ".jpg", ".png", ".webp"}
IMAGE_MAX_WIDTH = 2000
IMAGE_MAX_HEIGHT = 2000
IMAGE_MAX_DECODED_PIXELS = 20_000_000
IMAGE_MAX_SOURCE_BYTES = 20 * 1024 * 1024
IMAGE_MAX_BASE64_BYTES = 5 * 1024 * 1024
IMAGE_TARGET_BYTES = int(IMAGE_MAX_BASE64_BYTES * 3 / 4)
