...
const COMMANDS: CommandSuggestion[] = [
  ...
  { command: '/skill-stats', description: 'Show Skill evolution statistics' },
  { command: '/skill-eval', description: 'Evaluate online Skill evolution' },
  { command: '/extract_now ', description: 'Extract the pending Skill window' },
  { command: '/skill-feedback ', description: 'Record feedback for a Skill' },
